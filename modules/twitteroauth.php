  ...
  function getHeader($ch, $header) {
    ...
    return strlen($header);
		...
		function convert_links($status,$targetBlank=true,$linkMaxLen=250){
			...
			// convert @ to follow
				$status = preg_replace_callback("/(@([_a-z0-9\-]+))/i","<a href=\"http://twitter.com/$2\" title=\"Follow $2\" $target >$1</a>",$status);
			 
			// convert # to search
				$status = preg_replace_callback("/(#([_a-z0-9\-]+))/i","<a href=\"https://twitter.com/search?q=$2\" title=\"Search $1\" $target >$1</a>",$status);
