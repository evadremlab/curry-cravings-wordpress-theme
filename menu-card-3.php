<?php
/**
 * Template Name: Menu Card 3 Columns
...
<div class="inner">
	...
	<div class="element portfolio3filter_wrapper">
		...
		<div class="one_third gallery3 filterable gallery_type animated<?php echo $key+1; ?> static" data-id="post-<?php echo $key+1; ?>">
			<?php 
	                ...
	                <div class="thumb_content">
				        <div id="portfolio_desc_<?php echo $menu_ID; ?>" class="portfolio_desc portfolio2 textleft">
				            ...
				            <?php
				    			...
				    			{
				            ?>
				            <div class="menu_highlight small"><?php echo $menu_highlight_title[0]; ?></div>
				            <?php
				            	}
				            ?>
				        </div>
