<?php
/**
 * Template Name: Menu Card 4 Columns
...
<div class="inner">
	...
	<div class="element">
		...
		<div class="one_fourth gallery4 filterable gallery_type animated<?php echo $key+1; ?> static" data-id="post-<?php echo $key+1; ?>">
			<?php 
				...
				<a data-title="<strong><?php echo get_the_title(); ?></strong>" href="<?php echo $image_url[0]; ?>" class="fancy-gallery">
	                ...
	                <div class="thumb_content">
				        <div id="portfolio_desc_<?php echo $menu_ID; ?>" class="portfolio_desc portfolio2 textleft">
				            <h5 class="menu_post">
				            	<span class="menu_title small"><?php echo get_the_title(); ?></span>
