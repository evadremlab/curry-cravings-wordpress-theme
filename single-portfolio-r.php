    	 ...
    	 <div class="sidebar_content full_width nopadding">
	    	...
	    	<div class="sidebar_content ">
				...
				*/
				...
				{
					echo do_shortcode('[tg_gallery_slider gallery_id="'.$portfolio_gallery_id.'" width="670"]');
					echo '<br/>';
				}
				?>
			    ...
			    ?>
			    	...
			    	<div style="text-align:center">
				    	<iframe width="1170" height="658" src="//www.youtube.com/embed/<?php echo $portfolio_video_id; ?>?rel=0" frameborder="0" allowfullscreen></iframe><br/>
				    </div>
			    ...
			    ?>
			    	...
			    	<div style="text-align:center">
				    	<iframe src="//player.vimeo.com/video/<?php echo $portfolio_video_id; ?>?title=0&amp;byline=0&amp;portrait=0" width="1170" height="658" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe><br/>
				    </div>
			    <?php
			    	break;
